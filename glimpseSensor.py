...
class GlimpseSensor(function.Function):
	def __init__(self, center, output_size,depth=1, scale=2, using_conv = True):
	...
	def forward(self, images):
		...
		print(self.depth,'depth')#print('channel=', c)# [-1, 1]^2 -> [0, size_i - 1]x[0, size_i - 1]
		...
		for i in range(n):
			for j in range(self.depth):
				...
				#print(y.shape, cropped.shape)# TODO: resize images
